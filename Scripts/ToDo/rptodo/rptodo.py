...
class Todoer:
    ...
    def get_todo_list_sorted(self) -> List[Dict[str, Any]]:
        """Return the current to-do list sorted by priority."""
        read = self._db_handler.read_todos()
        return sorted(read.todo_list, key=lambda todo: todo['Priority'])
